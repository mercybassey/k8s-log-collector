def get_kubernetes_resource(k8s_apps_v1, k8s_core_v1, namespace, resource_name, resource_type):
    if resource_type == 'statefulset':
        ...
        return k8s_core_v1.read_namespaced_pod(resource_name, namespace)
    else:
