...
def test_retrieve_and_upload_logs_log_upload_failure(caplog):
    ...
    with patch('src.retrieve_and_upload_logs.get_kubernetes_resource', return_value=MagicMock()), \
         patch('src.retrieve_and_upload_logs.list_pods_for_resource', return_value=MagicMock(items=[mock_pod])), \
...
def test_retrieve_and_upload_logs_success(caplog):
    ...
    with patch('src.retrieve_and_upload_logs.get_kubernetes_resource', return_value=MagicMock()), \
         patch('src.retrieve_and_upload_logs.list_pods_for_resource', return_value=MagicMock(items=[MagicMock(), MagicMock()])), \
